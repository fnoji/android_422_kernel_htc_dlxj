...
#ifdef CONFIG_MSM_CAMERA
	struct i2c_registry impression_j_camera_i2c_devices = {
		I2C_SURF | I2C_FFA | I2C_LIQUID | I2C_RUMI,
		APQ_8064_GSBI4_QUP_I2C_BUS_ID,
		impression_j_camera_board_info.board_info,
		impression_j_camera_board_info.num_i2c_board_info,
	};

	struct i2c_registry impression_j_camera_i2c_devices_xb = {
		I2C_SURF | I2C_FFA | I2C_LIQUID | I2C_RUMI,
		APQ_8064_GSBI4_QUP_I2C_BUS_ID,
		impression_j_camera_board_info_xb.board_info,
		impression_j_camera_board_info_xb.num_i2c_board_info,
	};
...
#ifdef CONFIG_MSM_CAMERA
	if ( system_rev == XA ) {
		if (impression_j_camera_i2c_devices.machs & mach_mask)
			i2c_register_board_info(impression_j_camera_i2c_devices.bus,
				impression_j_camera_i2c_devices.info,
				impression_j_camera_i2c_devices.len);
	} else if ( system_rev == XB || system_rev == XC) {
		if (impression_j_camera_i2c_devices_xb.machs & mach_mask)
			i2c_register_board_info(impression_j_camera_i2c_devices_xb.bus,
				impression_j_camera_i2c_devices_xb.info,
				impression_j_camera_i2c_devices_xb.len);
	}
#endif
	if (gy_type == 2) {
