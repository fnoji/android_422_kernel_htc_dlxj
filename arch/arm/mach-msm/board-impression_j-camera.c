...
static struct msm_gpiomux_config impression_j_cam_common_configs_xc[] = {
#if 0
	{
		.gpio = CAM_PIN_GPIO_CAM_MCLK1,
		.settings = {
...
static struct msm_camera_rawchip_info impression_j_msm_rawchip_board_info_xc = {
	.rawchip_reset	= CAM_PIN_GPIO_RAW_RSTN,
...
struct platform_device impression_j_msm_rawchip_device_xc = {
	.name	= "rawchip",
	.dev	= {
		.platform_data = &impression_j_msm_rawchip_board_info_xc,
	},
};
...
#ifdef CONFIG_IMX091
static int impression_j_imx091_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int impression_j_imx091_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	.sensor_name	= "imx091",
	.camera_power_on = impression_j_imx091_vreg_on,
	.camera_power_off = impression_j_imx091_vreg_off,
	.pdata	= &impression_j_msm_camera_csi_device_data[0],
...
static int impression_j_s5k3h2yx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int impression_j_s5k3h2yx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.camera_power_on = impression_j_s5k3h2yx_vreg_on,
	.camera_power_off = impression_j_s5k3h2yx_vreg_off,
	.pdata	= &impression_j_msm_camera_csi_device_data[0],
...
static int impression_j_s5k6a1gx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int impression_j_s5k6a1gx_vreg_off(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6a1gx_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = impression_j_s5k6a1gx_vreg_on,
	.camera_power_off = impression_j_s5k6a1gx_vreg_off,
	.pdata	= &impression_j_msm_camera_csi_device_data[1],
...
#ifdef CONFIG_I2C
static struct i2c_board_info impression_j_camera_i2c_boardinfo[] = {
...
static struct i2c_board_info impression_j_camera_i2c_boardinfo_xb[] = {
...
struct i2c_board_info impression_j_camera_i2c_boardinfo_xd_imx175_ar0260[] = {
#ifdef CONFIG_IMX175
		{
		I2C_BOARD_INFO("imx175", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx175_data_xb,
...
struct i2c_board_info impression_j_camera_i2c_boardinfo_xd_imx175_ov2722[] = {
#ifdef CONFIG_IMX175
		{
		I2C_BOARD_INFO("imx175", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx175_data_xb,
...
struct i2c_board_info impression_j_camera_i2c_boardinfo_xd_ov8838_ar0260[] = {
...
struct i2c_board_info impression_j_camera_i2c_boardinfo_xd_ov8838_ov2722[] = {
...
struct msm_camera_board_info impression_j_camera_board_info = {
	.board_info = impression_j_camera_i2c_boardinfo,
	.num_i2c_board_info = ARRAY_SIZE(impression_j_camera_i2c_boardinfo),
};

struct msm_camera_board_info impression_j_camera_board_info_xb = {
	.board_info = impression_j_camera_i2c_boardinfo_xb,
	.num_i2c_board_info = ARRAY_SIZE(impression_j_camera_i2c_boardinfo_xb),
};
...
int impression_j_camera_id(int* id)
{
	int rc=0;
...
void __init impression_j_init_cam(void)
{
	...
	if (system_rev >= XC) {
		msm_gpiomux_install(impression_j_cam_common_configs_xc,ARRAY_SIZE(impression_j_cam_common_configs_xc));
		platform_device_register(&impression_j_msm_rawchip_device_xc);
	} else {
		msm_gpiomux_install(impression_j_cam_common_configs,ARRAY_SIZE(impression_j_cam_common_configs));
		platform_device_register(&impression_j_msm_rawchip_device);
	}
	...
	if (system_rev >= XD) {
		...
		rc = impression_j_camera_id(&camera_id);
		if (rc<0)
		{
		...
		if (camera_id ==0 && (engineerid&1)==0)
		{
			i2c_register_board_info(MSM_8960_GSBI4_QUP_I2C_BUS_ID,
				impression_j_camera_i2c_boardinfo_xd_imx175_ar0260,
				ARRAY_SIZE(impression_j_camera_i2c_boardinfo_xd_imx175_ar0260));
		}
		else if (camera_id ==0 && (engineerid&1)==1)
		{
			i2c_register_board_info(MSM_8960_GSBI4_QUP_I2C_BUS_ID,
				impression_j_camera_i2c_boardinfo_xd_imx175_ov2722,
				ARRAY_SIZE(impression_j_camera_i2c_boardinfo_xd_imx175_ov2722));
		}
		else if (camera_id ==1 && (engineerid&1)==0)
		{
			i2c_register_board_info(MSM_8960_GSBI4_QUP_I2C_BUS_ID,
				impression_j_camera_i2c_boardinfo_xd_ov8838_ar0260,
				ARRAY_SIZE(impression_j_camera_i2c_boardinfo_xd_ov8838_ar0260));
		}
		else if (camera_id ==1 && (engineerid&1)==1)
		{
			i2c_register_board_info(MSM_8960_GSBI4_QUP_I2C_BUS_ID,
				impression_j_camera_i2c_boardinfo_xd_ov8838_ov2722,
				ARRAY_SIZE(impression_j_camera_i2c_boardinfo_xd_ov8838_ov2722));
		}
	}
#endif
