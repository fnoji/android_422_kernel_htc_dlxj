...
static int impression_j_get_hw_component(void)
{
    int hw_com = 0;
...
static int impression_j_enable_digital_mic(void)
{
	if(system_rev >= XC)
		return 1;
	else
...
static struct acoustic_ops acoustic = {
        .enable_digital_mic = impression_j_enable_digital_mic,
        .get_hw_component = impression_j_get_hw_component,
